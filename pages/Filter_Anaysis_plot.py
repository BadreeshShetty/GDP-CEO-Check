...
st.set_page_config(
    page_title="Filtering Analysis: GDP, GDP/Capita, Pop., CEO Pay", layout="wide")

st.markdown("# Filtering Analysis: GDP, GDP/Capita, Pop., CEO Pay")
st.sidebar.header("Filtering Analysis: GDP, GDP/Capita, Pop., CEO Pay")
